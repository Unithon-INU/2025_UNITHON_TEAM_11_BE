...
import static Uniton.Fring.global.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.MODE_PARAM;
import static Uniton.Fring.global.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM;
    ...
    protected String setTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        if ("login".equalsIgnoreCase(mode)) {
            ...
            if (!customOAuth2UserService.checkUserPresent(userPrincipal.getName())) {
                ...
                log.debug("Refresh token generated: {}", loginResponseDto.getRefreshToken());
